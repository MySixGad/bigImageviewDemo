package com.example.siyan.imagedemo.custom;
...
public class ImageSurfaceView extends SurfaceView implements SurfaceHolder.Callback, OnGestureListener  {
    ...
    private void init(Context context){
        gestureDectector = new GestureDetector(context,this);   //单手
        getHolder().addCallback(this);
        scaleGestureDetector = new ScaleGestureDetector(context, new ScaleListener()); //双手
    }
    //endregion
